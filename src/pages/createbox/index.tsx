...
import ArtistNftButton from './components/ArtistNftButton';
import LeftBoxs from './components/LeftBoxs';
import MyNftButton from './components/MyNftButton';
    ...
    return (
        <Wrapper>
            ...
            <Grid columns="1fr 3fr" gap="58px">
                ...
                {selected === 'lootbox' && (
                    <CardWrapper>
                        {Lootbox.map((nfts, key) => (
                            <NftBox nft={nfts.name} key={key} />
                        ))}
                    </CardWrapper>
                )}
                {selected === 'mysterybox' && (
