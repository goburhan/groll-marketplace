            ...
            <PageWrapper>
                <Flex>
                    ...
                    <Flex gap="32px">
                        ...
                        <Flex direction="row">
                            <Flex>
                                ...
                                <Text color="#777E90">
                                    Choose an exiting collection or create a new
                                    one
                                </Text>
                            </Flex>
                    ...
                    <Collections>
                        <Clear color="#9197AE">
                            <img
                                src="/images/Icons/Circleplus.svg"
                                alt="basic"
                            />
                            Create Collection
                        </Clear>
                        <Clear color="#FDC673">
                            <img
                                src="/images/Icons/Legendplus.svg"
                                alt="legendary"
                            />
                            Legend Crypto
                        </Clear>
                        <Clear color="#7614F3">
                            <img src="/images/Icons/Epicplus.svg" alt="epic" />
                            Epic Crypto
                        </Clear>
                        <Clear color="#09ABF9">
                            <img src="/images/Icons/Rareplus.svg" alt="rare" />
                            Rare Crypto
                        </Clear>
                    </Collections>
