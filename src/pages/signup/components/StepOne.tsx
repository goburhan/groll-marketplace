...
import { Text16, Text14 } from '../../../components/StyledComponents/Text';
            ...
            <Flex>
                ...
                <Checker>
                    ...
                    <Text14 color={({ theme }) => theme.lowerdetail}>
                        Yes, you may send me marketing emails
                    </Text14>
                </Checker>
                ...
                <Checker>
                    <CustomizedCheckbox />
                    <Text14 color={({ theme }) => theme.lowerdetail}>
                        I’d like to receive email notifactions
                    </Text14>
                </Checker>
                ...
                <AddMore>
                    <img src="/images/Staticlogos/Addicon.svg" alt="social" />
