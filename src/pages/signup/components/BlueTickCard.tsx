    ...
    return (
        <SelfieContainer>
            ...
            <Text mt="3rem" size="14px">
                In order to be eligible to apply for the blue checkmark, your
                account must meet the following criteria for verification: The
                Account Must Be Authentic: In order to be considered for
                verification, your account must represent a registered business
                or entity, or it must belong to a real person.
            </Text>
        </SelfieContainer>
    );
}
