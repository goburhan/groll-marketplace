...
export default function StepOneButton() {
    ...
    function ProgressBar(one: any) {
        ...
        const isOpen = Object.values(open);
            ...
            <div style={{ width: '100%' }}>
                <AnimatePresence>
                    <ButtonWrapper
                        ...
                        variants={
                            isMobile
                                ? MButtonParentVariants
                                : ButtonParentVariants
                        }
                        ...
                        >
                            {disable ? (
                                <Link href="/editprofile">
                                    <EditButton>
                                        <img src="/images/Icons/Editbutton.svg" alt='editprofile' />
                                        <Text14
                                            mobileSize="12px"
